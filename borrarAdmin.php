...
<body>
    ...
    echo "<h1>¿Seguro que quieres borrar este registro?</h1> <br>"; 
    ...
    <div class="mb-3">
        ...
        <form action="borrar.php">
            ...
            <input class="btn btn-primary position-relative" type=submit value="Borrar" onclick="location.href = 'borrar.php?boleta=<?php echo $mostrar['boleta']?>'";>
        </form>
    </div>
