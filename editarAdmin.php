...
<body>
    ...
    $apePaterno = $mostrar["apePaterno"];
    $apeMaterno = $mostrar['apeMaterno'];
    ...
    $curp = $mostrar['curp'];
    $calle = $mostrar['calle'];
    $colonia = $mostrar['colonia'];
    $alcaldia = $mostrar["alcaldia"];
    if($alcaldia == "alvaro"){
    ...
    $entidadProcedencia = $mostrar['entidadProcedencia'];
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-auto mt-2" id="grupo-control-genero" value = <?php echo $genero ?>>  <!--Arreglar><-->
                        <div class="form-check form-check-inline">
                            ...
                            <?php   if($mostrar["genero"] == "Femenino") { ?>
                                 checked 
                            <?php } ?>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <?php   if($mostrar["genero"] == "Masculino") { ?>
                                 checked 
                            <?php } ?>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-auto mb-3" id="grupo-control-alcaldia">
                        <select class="form-select" id="dir3" name="alcaldia">
                            ...
                            <option selected value = <?php echo $mostrar["alcaldia"] ?> > <?php echo $alcaldia ?> </option>         <!--Arreglar><-->
                ...
                <div class="mb-3 row" id="grupo-control-escuelaProcedencia">
                    ...
                    <div class="col-auto mb-3">
                        <select class="form-select" id="escuelaProcedencia" name="escuelaProcedencia">
                            ...
                            <option selected value = <?php echo $mostrar["escuelaProcedencia"] ?> > <?php echo $escuelaProcedencia ?> </option>   <!--Arreglar><-->
                    ...
                    <div class="col-auto" id="grupo-control-entidadProcedencia">
                        <select class="form-select" id="entidadProcedencia" name="entidadProcedencia">
                            ...
                            <option selected value = <?php echo $mostrar["entidadProcedencia"] ?>> <?php echo $entidadProcedencia ?> </option>         <!--Arreglar><-->
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-auto">
                        <select class="form-select" id="n_opcion" name="opcion">
                            <option selected value = <?php echo $mostrar["opcion"] ?> > <?php echo $opcion ?> </option> <!--Arreglar><-->
